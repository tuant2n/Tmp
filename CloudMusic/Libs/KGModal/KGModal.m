...
CGFloat const kDefaultCloseButtonPadding = 16.0;
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    styleLayer.cornerRadius = 3;
    styleLayer.shadowColor= [[UIColor clearColor] CGColor];
...
- (instancetype)init{
    if(!(self = [super initWithFrame:(CGRect){0, 0, 20, 20}])){
        return nil;
    }
    static UIImage *closeButtonImage;
    static dispatch_once_t once;
    dispatch_once(&once, ^{
        closeButtonImage = [UIImage imageNamed:@"closePopup"];
    });
